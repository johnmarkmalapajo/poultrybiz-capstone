...
const cards = [
  {
    ...
    emoji: "🌾",
    description: "Track feed stock levels and supplies",
    color: "#e8a020",
    bg: "#fff8ec",
  ...
  },
  {
    ...
    emoji: "🐔",
    description: "Monitor daily feed usage per flock",
    color: "#5aab6e",
    bg: "#edf7f0",
  ...
  {
    id: "equipment",
    label: "Equipment & Tool Record",
    emoji: "🔧",
    description: "Manage tools and farm equipment",
    color: "#4a90d9",
    bg: "#eef4fc",
