...
const cards = [
  ...
  { 
    ...
    emoji: "🔒", 
    description: "Monitor isolated and quarantined birds",
    color: "#9c27b0", 
    bg: "#f3e5f5", 
    path: "/records/quarantine" 
  },
  { 
    id: "manure",
    label: "Manure & Waste Record", 
    emoji: "♻️", 
    description: "Track manure collection and waste management",
    color: "#795548", 
    bg: "#efebe9", 
    path: "/records/manure" 
  },
